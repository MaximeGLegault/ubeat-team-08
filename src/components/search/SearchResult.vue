<template>
  <div>
    ...
    <!--/>-->
    <!--<result-by-artist v-else-if="this.results.artists"-->
                      <!--:key="this.searchTerm"-->
                      <!--:results="this.results.artists"-->
    <!--/>-->
    <!--<result-by-album v-else-if="this.results.albums"-->
                     <!--:key="this.searchTerm"-->
                     <!--:results="this.results.albums"-->
    <!--/>-->
...
<script>
    import ResultByTrack from './ResultByTrack';
